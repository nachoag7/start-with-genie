  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (hairlineRef.current) {
        hairlineRef.current.style.opacity = '1';
      }
    }, 300);
    ...
    <section className="relative py-24">
      <SectionReveal>
        <div className="mx-auto max-w-2xl px-6 text-center relative">
          ...
          <div 
            ref={hairlineRef}
            className="absolute -top-2 left-1/2 -translate-x-1/2 w-16 h-px bg-gradient-to-r from-transparent via-neutral-300 to-transparent opacity-0 transition-opacity duration-500 ease-smooth" 
          />
