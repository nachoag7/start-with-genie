  ...
  return (
    ...
    >
      ...
      <ContactSupportModal isOpen={isSupportModalOpen} onClose={() => setIsSupportModalOpen(false)} />
          ...
          className="w-full max-w-[420px] bg-white rounded-xl shadow-lg px-7 flex flex-col items-center gap-4"
          style={{
            borderRadius: 12,
        ...
        >
          ...
          <motion.img
            ...
            alt="Genie Icon"
            className="w-5 h-5"
            style={{ width: 24, height: 24, margin: 0, padding: 0, display: 'block' }}
          ...
          <h2
            ...
            style={{ fontWeight: 600, fontSize: 20, margin: 0, padding: 0, lineHeight: 1.2 }}
          >
            Start With Genie — One-Time LLC Launch Assistant
          </h2>
          {/* What You're Getting Block */}
          <div
            style={{ background: '#f9f9f9', borderRadius: 8, padding: '0.75rem 1rem', fontSize: 14, color: '#444', margin: 0, width: '100%' }}
          >
            <strong style={{ fontWeight: 500 }}>What you're getting:</strong>
            <ul style={{ listStyle: 'none', padding: 0, margin: '0.5rem 0 0 0', textAlign: 'left' }}>
              {[
                [<ListChecks size={16} style={{ marginRight: '0.5rem', color: '#666' }} />, 'Step-by-step LLC instructions'],
                [<BadgeDollarSign size={16} style={{ marginRight: '0.5rem', color: '#666' }} />, 'EIN walkthrough'],
                [<FileEdit size={16} style={{ marginRight: '0.5rem', color: '#666' }} />, 'Customizable operating agreement'],
                [<CheckCircle size={16} style={{ marginRight: '0.5rem', color: '#666' }} />, 'Launch checklist'],
                [<Zap size={16} style={{ marginRight: '0.5rem', color: '#666' }} />, 'Instant access after checkout'],
              ].map(([icon, text], idx) => (
                <li
                  key={idx}
                  style={getListItemStyle(idx)}
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div>
              <label className="block text-[14px] font-medium text-gray-700 mb-1">Card Details</label>
              <div
                className="w-full focus-within:border-blue-500 transition-all duration-150 ease-in-out"
                  ...
                  options={{ 
                    style: { 
                      base: { 
                        ...
                        '::placeholder': { color: '#888', fontSize: '15px' },
          ...
          <motion.button
            type="submit"
            className="w-full rounded-lg font-semibold text-base text-white bg-gradient-to-br from-[#3A8DFF] to-[#1F6BFF] shadow-sm hover:shadow-md hover:brightness-105 focus:ring-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none transition-all ease-in-out duration-200 py-[0.8rem] px-6 mt-1 mb-0"
            style={{ borderRadius: 8, fontWeight: 600, fontSize: 16, padding: '0.8rem 1.5rem' }}
            disabled={loading || !stripe || !elements || success}
          ...
          {/* Trust Signals */}
          <p className="text-[13px] text-gray-500 text-center mt-2 mb-0">
            Secure checkout via Stripe — one-time payment, no subscriptions
          </p>
        </form>
        
        {/* Footer with homepage-style links */}
        <nav className="flex justify-center items-center gap-4 text-sm text-neutral-500 mt-8" style={{ width: '100%' }}>
          ...
          <button
            type="button"
            className="hover:text-neutral-900 transition-colors duration-200 focus:outline-none"
            onClick={() => setIsSupportModalOpen(true)}
            style={{ background: 'none', border: 'none', padding: 0, font: 'inherit', cursor: 'pointer' }}
          >
            Contact support
