...
export default function GenieChat({ avatarSrc }: GenieChatProps) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white shadow rounded-xl flex flex-col h-[60vh]">
      <div className="px-6 py-4 border-b border-gray-200 flex items-center gap-3">
        <img src={avatarSrc} alt="Genie" className="h-10 w-10 rounded-full border" />
            ...
            <div className={`max-w-[75%] px-4 py-2 rounded-2xl shadow-sm ${msg.isUser ? 'bg-blue-600 text-white' : 'bg-white text-gray-900 border border-gray-200'}`}>
              {!msg.isUser && (
                <div className="flex items-center mb-1 gap-2">
                  <img src={avatarSrc} alt="Genie" className="h-6 w-6 rounded-full border" />
