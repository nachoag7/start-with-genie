          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <ul className="list-none space-y-6 text-lg text-neutral-600 leading-relaxed mb-4">
                <li className="flex items-start gap-3"><CheckCircle className="w-6 h-6 text-green-600 mt-1" /><span><span className="font-semibold text-neutral-900">Protect your personal assets</span><br />If a client sues you or there’s a contract issue, your personal savings could be at risk. An LLC separates your business legally—so your personal assets stay safe.</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="w-6 h-6 text-green-600 mt-1" /><span><span className="font-semibold text-neutral-900">Look more professional</span><br />Clients take you more seriously when your invoices and contracts come from a real business name. It helps you charge more—and win better work.</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="w-6 h-6 text-green-600 mt-1" /><span><span className="font-semibold text-neutral-900">Open a business bank account</span><br />No more mixing PayPal income with your personal checking. A business account keeps things clean and unlocks better financial tools.</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="w-6 h-6 text-green-600 mt-1" /><span><span className="font-semibold text-neutral-900">Make tax season easier (and smarter)</span><br />With an LLC, you can separate business income and expenses—making deductions easier and your accountant happier. You might even save money.</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="w-6 h-6 text-green-600 mt-1" /><span><span className="font-semibold text-neutral-900">Future-proof your business</span><br />An LLC makes it easier to grow, hire, and build real systems—whether you stay solo or scale up.</span></li>
              </ul>
            </motion.div>
          </div>
        </section>
