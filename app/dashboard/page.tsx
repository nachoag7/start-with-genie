    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div className="w-full flex flex-col lg:flex-row gap-12 lg:gap-16 items-start justify-center">
          {/* Main Content Column */}
          <div className="w-full lg:w-2/3 max-w-2xl mx-auto flex flex-col gap-8">
            {/* Welcome Section */}
            <div className="bg-white shadow-sm rounded-2xl px-8 py-8 flex flex-col items-center text-center border border-gray-100">
              <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2">Welcome back, <span className="text-primary-600">{user.full_name}</span>!</h1>
              <p className="text-base text-gray-500 font-light mb-1">{user.business_name} &mdash; {user.state}</p>
            </div>

            {/* Setup Checklist */}
            <div className="bg-white rounded-2xl shadow-sm px-8 py-7 border border-gray-100 flex flex-col gap-4">
            ...
            {/* Documents Section */}
            <div className="bg-white rounded-2xl shadow-sm px-8 py-7 border border-gray-100 flex flex-col gap-6">
              <div className="flex items-center justify-between mb-2">
          ...
          <div className="hidden lg:block absolute left-2/3 top-0 h-full w-px bg-gray-200" style={{ zIndex: 0 }} />
        </div>
      </div>
