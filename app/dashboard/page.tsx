      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div className="w-full flex flex-col lg:flex-row gap-12 lg:gap-16 items-start justify-center">
          ...
          <div className="w-full lg:w-2/3 max-w-2xl mx-auto flex flex-col gap-12">
            ...
            {/* Setup Checklist & Documents as aligned cards */}
            <div className="flex flex-col gap-8 md:gap-10">
              <div className="bg-white rounded-2xl shadow-sm px-8 py-7 border border-gray-100 flex flex-col gap-4 w-full">
              ...
              <div className="bg-white rounded-2xl shadow-sm px-8 py-7 border border-gray-100 flex flex-col gap-6 w-full">
                <div className="flex items-center justify-between mb-2">
